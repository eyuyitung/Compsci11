...
class Entity
{
  ...
  Entity (int a, int d, int s, int h, int sta, String n, int cc, float cm, int am, int et, int en, boolean ps)
  {
    attack=a;
    defence=d;
    speed=s;
  ...
  Entity (int l,int en)
  {
    this(l*5, l*5, l*5, l*50, 0, "Goblin", 0,1.5,0, 0, en, true);
  }

  Entity () //enemy/player
  {  
    this(5, 5, 5, 50, 0, "",0, 1.0, 0, 0, 0, false);
  }
